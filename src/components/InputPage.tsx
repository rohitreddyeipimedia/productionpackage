        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10 pt-10">
            ...
            <p className="text-white/60 text-lg">
              {input?.title} • {packs?.shots.length || 0} shots • {mjPrompts.length} MJ prompts
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all group">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">MJ Prompts (.txt)</h3>
              <p className="text-white/50 text-sm mb-4">Clean text file with all Midjourney prompts only</p>
              <button
                onClick={downloadTxt}
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all group">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">MJ Prompts (.doc)</h3>
              <p className="text-white/50 text-sm mb-4">Formatted Word document with all MJ prompts</p>
              <button
                onClick={downloadDoc}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {isGenerating && (
            <div className="bg-white/5 rounded-xl p-6 space-y-3">
              ...
              <div className="flex items-center gap-3 text-white/40">
                <div className="w-4 h-4 rounded-full border-2 border-white/20" />
                <span className="text-sm">Creating production packs...</span>
              </div>
              <div className="flex items-center gap-3 text-white/40">
                <div className="w-4 h-4 rounded-full border-2 border-white/20" />
                <span className="text-sm">Building MJ prompts...</span>
              </div>
            </div>
          )}
        </form>
